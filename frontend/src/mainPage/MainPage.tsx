            ...
            <div className="flex flex-col max-w-[960px] flex-1">
              ...
              {!showStt ? (
                ...
                selectedFileIndex === null || !files[selectedFileIndex] ? (
                  <div className="p-6 bg-white dark:bg-[#1a1f2b] rounded-lg shadow">
                    <p className="text-gray-600 dark:text-gray-300">파일을 다시 선택해 주세요.</p>
                    <button
                      onClick={() => setShowStt(false)}
                      className="mt-4 px-4 py-2 rounded bg-gray-300 hover:bg-gray-400 text-sm"
                    >
                      돌아가기
                    </button>
                  </div>
