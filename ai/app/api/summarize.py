...
3. **엄격한 JSON 문법**: 모든 문자열(Key, Value)은 반드시 쌍따옴표(")로 감싸야 합니다. 쌍따옴표를 절대 생략하지 마세요. 문자열 내의 따옴표는 이스케이프(\") 처리하세요.
4. **간결성**: 'description'은 2문장 내외, 'core_summary'는 최대 3개의 핵심 포인트로 작성하세요.
